 ...
 */
final class Version20250930120432 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX idx_1483a5e9786a81fb');
        $this->addSql('ALTER TABLE users DROP iduser_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users ADD iduser_id INT NOT NULL');
